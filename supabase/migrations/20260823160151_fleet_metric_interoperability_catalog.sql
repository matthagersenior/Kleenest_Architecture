-- Production reconciliation for the Fleet metric interoperability catalog.
-- The original architecture migration was authored earlier but had not reached production.
-- This migration records the production application without changing the contract.
