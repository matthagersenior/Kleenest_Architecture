-- Keep genuinely public discovery/catalog RPCs public, but remove PUBLIC
-- execution from account, entitlement, authorization, ownership, and
-- operational mutation helpers. Authenticated callers retain execution.
