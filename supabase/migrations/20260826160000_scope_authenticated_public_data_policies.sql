-- Align repository migrations with the live RLS authorization boundary.
alter policy business_campaigns_member_select on public.business_campaigns to authenticated;
...
alter policy location_ingestion_admin_read on public.location_ingestion_jobs to authenticated;
