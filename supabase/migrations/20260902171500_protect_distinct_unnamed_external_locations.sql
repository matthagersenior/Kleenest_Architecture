-- Preserve source-identified locations when generic names would otherwise cause
-- proximity-based over-deduplication. Named records still receive conservative
-- same-name/nearby matching, with a tighter ~28m coordinate window.
