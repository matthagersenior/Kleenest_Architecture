export const WORKSPACE_MISSIONS=Object.freeze({
  consumer:Object.freeze({
    ...
    requiredDomains:['locations','discovery','maps','checkins','reviews','evidence','progression','quests','rewards','reputation','community','notifications','offline'],
  ...
  fleet:Object.freeze({
    ...
    requiredDomains:['fleet','maps','routing','locations','geofencing','leaderboards','notifications','analytics','intelligence','reporting','offline'],
