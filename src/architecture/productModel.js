export const PRODUCT_TIERS = Object.freeze({
  ...
  business: Object.freeze({
    standard: Object.freeze({ id: 'business_standard', label: 'Business', ads: false, workspaces: ['business'], capabilities: ['business'], lockedCapabilities: ['businessGrowth', 'businessIntelligence', 'enterprise', 'fleet', 'businessEngagement', 'advancedCampaigns', 'advancedContests', 'advancedEvents'] }),
