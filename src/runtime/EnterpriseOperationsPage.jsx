...
export default function EnterpriseOperationsPage({ mode = 'partners' }) {
  ...
  return <WorkspaceShell workspace="enterprise">
    <section className="page enterprise-page">
      ...
      {(mode==='performance'||mode==='campaigns')&&<AiAssistPanel task="enterprise_network" title="Enterprise network copilot" description="Interprets the network, benchmark, allocation, and campaign facts loaded on this screen. It cannot change campaigns, allocations, or memberships." instruction="Identify the three most important decisions or anomalies to review. Cite the supplied network, benchmark, allocation, or campaign metrics and do not invent causal attribution." context={{networkId,businessName:selectedBusinessName,mode,report,roi,allocation,campaign,campaignType,campaignName}} actionLabel="Analyze network"/>}
