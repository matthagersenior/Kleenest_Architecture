...
export default function FleetRouteStopPlanner({businessId,route}){
  ...
  return <section className="fleet-stop-planner">
    ...
    {dispatchIntel&&<AiAssistPanel task="fleet_dispatch" context={{route,dispatch:dispatchIntel,stops}} title="Fleet dispatch copilot" description="Explains assignment risk, stop priorities, and timing considerations from current Fleet facts." instruction="Give the dispatcher the most important actions to take before dispatch. Do not invent traffic or travel times."/>}
