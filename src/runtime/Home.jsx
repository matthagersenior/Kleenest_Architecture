...
const actions = [
  ...
  { to:'/search', icon:Search, title:'Ask Kleenest', text:'Describe what you need in your own words and let Kleenest interpret the request against canonical location facts.', label:'Search naturally' },
...
export default function Home(){
  ...
  return <WorkspaceShell workspace={workspace}>
    <main className="page home-page">
      ...
      <section className="home-secondary-grid"><Link className="detail-panel home-panel-link" to="/family"><div className="panel-heading"><div><span className="eyebrow">HOUSEHOLD</span><h2>Family</h2></div><Heart size={20}/></div><p>Keep shared participation and household coordination together.</p><span className="text-link">Open Family <ArrowRight size={15}/></span></Link><Link className="detail-panel home-panel-link" to="/intelligence"><div className="panel-heading"><div><span className="eyebrow">NETWORK</span><h2>Intelligence</h2></div><Search size={20}/></div><p>Explore recommendations and network-level signals.</p><span className="text-link">Open Intelligence</span></Link><Link className="detail-panel home-panel-link" to="/support"><div className="panel-heading"><div><span className="eyebrow">HELP</span><h2>Need a hand?</h2></div><Users size={20}/></div><p>Get support, report a problem, or suggest a feature.</p><span className="text-link">Open Support <ArrowRight size={15}/></span></Link></section>
