...
export default function Home(){
  ...
  return <WorkspaceShell workspace={workspace}>
    <main className="page home-page">
      ...
      <footer className="home-footer"><span>{loading ? 'Loading your account…' : 'Kleenest gets better when every visit makes the network smarter.'}</span><div><Link className="text-link" to="/pricing">Membership</Link><Link className="text-link" to="/support">Support</Link><Link className="text-link" to="/about">About</Link></div>
    </main>
  </WorkspaceShell>;
}