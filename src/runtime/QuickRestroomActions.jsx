...
function bestOf(places, mode) {
  ...
  return rows.sort((a, b) => cleanlinessScore(b) - cleanlinessScore(a) || ratingScore(b) - ratingScore(a) || freshnessScore(b) - freshnessScore(a) || distanceScore(a) - distanceScore(b))[0];
}
