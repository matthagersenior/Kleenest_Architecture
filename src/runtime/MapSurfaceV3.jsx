...
import { brandIconCandidates, markerIcon, placeBrand, placeStatus, bathroomIntelligence, bathroomSignalLabel, safeText, spiderfyPosition } from './MapMarkerSystem.jsx';
...
export default function MapSurfaceV3(){
  ...
  return <WorkspaceShell><section className="page-head map-surface map-v3">
    <div className="map-heading"><div><span className="eyebrow">Explore</span><h1>Map & location intelligence</h1><p>Search the live Kleenest network by distance. Bathroom intelligence is attached to the same canonical discovery result, so the map never has to reconcile a second location dataset.</p></div></div>
