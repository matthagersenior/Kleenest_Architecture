...
export function AppProvider({ children }) {
  ...
  const value = useMemo(() => ({ ...state, services, membershipTier: getMembershipTier(state.profile, state.entitlements), showAds: shouldShowAds(state.profile, state.entitlements), isPlatformOwner: isPlatformOwner(state.profile), identitySnapshot: createIdentitySnapshot({ user: state.user, profile: state.profile, entitlements: state.entitlements, loading: state.loading, error: state.error }), configured: Boolean(supabase), requireSupabase }), [services, state]);
