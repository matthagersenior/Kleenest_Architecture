...
export function createAdminOperationsService(client,{capabilityCoverage=null}={}){
  ...
  return Object.freeze({
    ...
    nationalIngestionStorageStatus:profile=>ownerRpc(profile,'national_ingestion_storage_status'),
    setNationalIngestionResumeAuthorization:(profile,authorized)=>ownerRpc(profile,'admin_set_national_ingestion_resume_authorization',{p_authorized:Boolean(authorized)}),
