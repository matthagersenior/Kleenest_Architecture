export function createReviewService(client,{quests=null}={}) {
  ...
  function refresh(locationId, reason, detail = {}) { if (locationId) emit('location-intelligence-refresh-requested', { locationId, reason, ...detail }); }
  return Object.freeze({
    create: async ({ locationId, checkInId = null, stars, cleanlinessPct = null, comment = null }) => {
      ...
      refresh(locationId, 'review_created', { reviewId });
