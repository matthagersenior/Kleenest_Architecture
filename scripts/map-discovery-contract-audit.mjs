...
const required=[
  ...
  ['AppContext.jsx',['createMapNetworkService','maps:createMapNetworkService','createUniversalDiscoveryService']]
];
const missing=[];
...
console.log('Canonical Map discovery audit passed: map RPC, bounded live discovery, attribution telemetry, route continuity, and non-demo fallback contracts are present.');
