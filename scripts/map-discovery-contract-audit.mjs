...
const required=[
 ...
 ['runtime/MapSurface.jsx',["from 'maplibre-gl'",'services?.maps?.nearby','discover:true',"category:'all'",'projectLocationAuthority','placeLogoCandidates','bathroomIntelligence','maplibregl.Marker','/route?locationId=']],
...
console.log('Canonical map discovery audit passed: MapSurface.jsx is the single MapLibre discovery surface backed by services.maps and canonical location authority.');
