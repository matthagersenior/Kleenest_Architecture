...
if (!/amenity\s*:\s*amenity\?\{\[amenity\]:true\}:\{\}/.test(surface) || !/category\s*:\s*['"]all['"]/.test(surface)) missing.push('runtime/MapSurfaceProduction.jsx: nearby request must be amenity-first with category=all');
