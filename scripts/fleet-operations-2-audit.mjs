...
const checks=[
 ...
 ['Route drilldown exposes exact evidence',['ROUTE EXCEPTION DRILL-DOWN','Stop timing evidence','Arrival variance','Route alerts','Authoritative events'],'src/runtime/FleetRouteExceptionDrilldownPanel.jsx'],
 ['Fleet routes expose manager actions scorecards and drilldown',['FleetExceptionIntelligencePanel','canManage={access.operate}','FleetAssetExceptionScorecardsPanel','FleetRouteExceptionDrilldownPanel'],'src/runtime/FleetRoutesPage.jsx'],
];
const failures=[];
