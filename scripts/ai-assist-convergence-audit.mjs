...
const required=[
 ['supabase/functions/ai-assist/index.ts',['verify','OPENAI_API_KEY','gpt-5.6-luna','allowedTasks','review_required:true','grounded_fallback','business_growth','fleet_dispatch','fleet_debrief','enterprise_network','notification_copy','visit_review','admin_moderation','route_plan']],
