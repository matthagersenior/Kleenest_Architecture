...
const required=[
 ['supabase/functions/ai-assist/index.ts',['verify','OPENAI_API_KEY','gpt-5.6-luna','allowedTasks','review_required:true','grounded_fallback','business_growth','fleet_dispatch','fleet_debrief','enterprise_network','visit_review','admin_moderation','route_plan']],
...
console.log('AI Assist convergence audit passed: one authenticated gateway, centralized service boundary, grounded fallback, pre/post Fleet intelligence, Business, Admin, consumer routing, and human review before mutations.');
