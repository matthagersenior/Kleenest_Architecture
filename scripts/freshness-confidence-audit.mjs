...
const required=[
 ...
 ['domains/locations/details.js',['trustState','get_location_trust_state','trust_freshness_score','trust_staleness_status']],
...
console.log('Freshness/confidence audit passed: canonical trust state, evidence refresh, user-facing location trust, and reverification contracts are wired.');
