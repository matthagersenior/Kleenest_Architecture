...
const checks=[
 ...
 ['Trust signals panel shows inventory trends and reverification',['CURRENT TRUST SIGNALS','Counted amenities','24h occupancy trend','Needs reverification','at least 2 distinct contributors'],'src/runtime/LocationTrustSignalsPanel.jsx'],
