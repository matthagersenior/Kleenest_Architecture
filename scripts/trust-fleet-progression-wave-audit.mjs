...
const checks=[
 ...
 ['Measurement panel collects amenity quantity',/REVIEW AMENITIES[\s\S]*How many\?[\s\S]*recordReviewAmenityInventory/,'src/runtime/VisitMeasurementsPanel.jsx'],
 ...
 ['Consumer service exposes occupancy authority',/submit_location_occupancy_observation[\s\S]*get_location_occupancy_summary/,'src/domains/consumer/location-evidence.js'],
 ...
 ['Fleet operational events create owner notifications',/trg_fleet_operational_notification[\s\S]*route_failed[\s\S]*job_failed/,'supabase/migrations/20260830002900_trust_fleet_occupancy_foundation.sql'],
 ['Fleet geofence events create owner notifications',/trg_fleet_geofence_notification[\s\S]*fleet-geofence/,'supabase/migrations/20260830002900_trust_fleet_occupancy_foundation.sql'],
 ...
 ['Fleet route failure is authoritative terminal state',/planned','active','completed','cancelled','paused','failed[\s\S]*route_failed/,'supabase/migrations/20260830003100_fleet_event_notification_delivery_v2.sql'],
