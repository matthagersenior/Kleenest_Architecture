...
const required=[
 ...
 ['domains/fleet/operations.js',['record_fleet_operational_event','authoritativeMutation','serverAuthoritative','kleenest:fleet-updated','kleenest:business-updated','fleet-mutation','semantic_location_search','searchStopLocations','subscribeDispatch','postgres_changes','fleet_routes','fleet_route_stops','fleet_dispatch_intelligence','dispatchIntelligence','fleet_assign_driver_user','assignDriverUser','fleet_set_route_stops','fleet_dispatch_route','fleet_record_route_stop_timing','fleet_route_performance','dispatchRoute','routePerformance']],
 ...
 ['runtime/FleetRouteCrudPanel.jsx',['FleetRouteStopPlanner','FleetRoutePerformanceCard','driver_id','vehicle_id','subscribeDispatch','realtime-dispatch']],
 ['runtime/FleetRouteStopPlanner.jsx',['searchStopLocations','dispatchIntelligence','Dispatch intelligence','Recommended service stops','priority_score','reasons','setRouteStops','planned_arrival_at','planned_ttl_minutes','planned_dwell_minutes','Save stop plan','Stop order is locked']],
...
console.log('Fleet → Enterprise → Network Intelligence convergence audit passed with searchable stop planning, dispatch intelligence, assigned-driver authority, single-source dispatch telemetry, realtime cross-device route/stop refresh, full ETA/TTL/dwell/duration metrics, and guarded operational intelligence execution.');
