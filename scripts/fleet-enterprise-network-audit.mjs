...
const required=[
 ...
 ['domains/fleet/operations.js',['record_fleet_operational_event','authoritativeMutation','serverAuthoritative','kleenest:fleet-updated','kleenest:business-updated','fleet-mutation','semantic_location_search','searchStopLocations','fleet_dispatch_intelligence','dispatchIntelligence','fleet_assign_driver_user','assignDriverUser','fleet_set_route_stops','fleet_dispatch_route','fleet_record_route_stop_timing','fleet_route_performance','dispatchRoute','routePerformance']],
...
console.log('Fleet → Enterprise → Network Intelligence convergence audit passed with searchable stop planning, dispatch intelligence, assigned-driver authority, single-source dispatch telemetry, full ETA/TTL/dwell/duration metrics, and guarded operational intelligence execution.');
