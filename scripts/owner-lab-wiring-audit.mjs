...
const requiredRoutes=[
  '/owner', '/owner/data', '/owner/preview', '/owner/audit', '/owner/intelligence', '/owner/reports', '/owner/reports/history'
];
...
const report={generatedAt:new Date().toISOString(),status:errors.length?'attention':'ok',checks:{ownerRoutes:requiredRoutes.length,crudGovernedServiceCalls:true,membershipControls:true,intelligenceServiceSurface:true,intelligenceLoop:true},errors};
